...
Public.food_values = {
    ['automation-science-pack'] = { value = 0.0011, name = 'automation science', color = '255, 50, 50' },
    ['logistic-science-pack'] = { value = 0.0028, name = 'logistic science', color = '50, 255, 50' },
    ['military-science-pack'] = { value = 0.0095, name = 'military science', color = '105, 105, 105' },
    ['chemical-science-pack'] = { value = 0.0345, name = 'chemical science', color = '100, 200, 255' },
    ['production-science-pack'] = { value = 0.1150, name = 'production science', color = '150, 25, 255' },
